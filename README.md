...
IOB LLC used the Quasar Fund to develop a brand new trading system from the ground up. Many trading signals were divided into many small orders to test various limits of the system. This resulted in less-than-optimal results but that was the purpose of the fund.
